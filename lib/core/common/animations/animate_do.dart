...
class AppAnimations {
  ...
  static Widget smartImage(
    ...
    Duration shimmerSpeed = const Duration(milliseconds: 1500),
    Duration assetShimmerDuration = const Duration(milliseconds: 600),
  }) {
    return SmartImageWithShimmer(
      ...
      assetShimmerDuration: assetShimmerDuration,
    );
  }
}
